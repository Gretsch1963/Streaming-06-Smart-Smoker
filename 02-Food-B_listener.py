"""
    ...
    messages which include the temperature of a food cooking in the smoker "02_Food-B". It will send an alert if the food has not warmed up by 
...
alert = "Warning! Food B is stalled and may not be warming up correctly, please check your food!"
