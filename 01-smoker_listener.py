"""
    ...
    messages which include the temperature of smoker every 30 seconds. It will send an alert if the temperature declines by more
    than 15 degrees during a 2.5 min interval. 
...
alert = "Warning! Smoker temperature is declining unexpectedly! Temperature has declined by more than 15 degrees in a 2.5 minute interval"
